      ...
      <div className='cards__container'>
        <div className='cards__wrapper'>
          <ul className='cards__items'>
            <CardItem
              src='luxuryCar/images/img-1.jpg'
              text='BMW M850i xDrive Automatic'
              path='#'
            />
            <CardItem
              src='luxuryCar/images/img-2.jpg'
          ...
          <ul className='cards__items'>
            <CardItem
              src='luxuryCar/images/img-3.jpg'
              text='Maserati Levante Trofeo V8'
              path='#'
            />
            <CardItem
              src='luxuryCar/images/img-4.jpg'
              text='Bentley Mulsanne W.O. Edition'
              path='#'
            />
            <CardItem
              src='luxuryCar/images/img-5.jpg'
            ...
            <ul className='cards__items'>
            <CardItem
              src='luxuryCar/images/img-6.jpg'
              text='Jaguar E-type Lightweight "Car Zero"'
              path='#'
            />
            <CardItem
              src='luxuryCar/images/img-7.jpg'
              text='Lamborghini Huracan Evo'
              path='#'
            />
            <CardItem
              src='luxuryCar/images/img-8.jpg'
            ...
            <ul className='cards__items'>
            <CardItem
              src='luxuryCar/images/img-9.jpg'
              text='Lexus RC-F Track Edition'
              path='#'
            />
            <CardItem
              src='luxuryCar/images/img-10.jpg'
              text='McLaren 650S Spider'
              path='#'
            />
            <CardItem
              src='luxuryCar/images/img-11.jpg'
